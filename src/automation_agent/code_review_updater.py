...
class CodeReviewUpdater:
    """Maintains a persistent log of code reviews in AUTOMATED_REVIEWS.md."""

    # Use distinct filename to avoid collision with CODE_REVIEW.md on case-insensitive filesystems
