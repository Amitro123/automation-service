...
### [2024-03-08]
- **Summary**: Updated README.md to reflect recent feature releases and clarify existing features. Removed "NEW" tags and clarified dashboard setup and mutation testing instructions. Updated the architecture diagram and added a note about automatic updates.
- **Decisions**: Removed "NEW" tags for features that are no longer new.
- **Next Steps**: Review and update spec.md to reflect the changes in the README.
