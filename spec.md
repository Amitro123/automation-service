...
### [2025-12-09]
- **Summary**: Removed the "The diagram updates automatically as the project evolves." note from README.md. This is likely because the diagrams are now manually maintained or are generated separately.
- **Decisions**: N/A
- **Next Steps**: Consider if the diagrams should be auto-generated or if the manual maintenance is sufficient.